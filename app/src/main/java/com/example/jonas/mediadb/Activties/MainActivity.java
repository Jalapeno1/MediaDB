...
import com.example.jonas.mediadb.Adapters.MovieCollectionGridView;
...
import com.example.jonas.mediadb.Utilities.TestData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), SearchResultsActivityDrawer.class);
                startActivity(i);
